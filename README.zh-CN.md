...
- **🪟 一岛一窗主面板** — 双击岛或 `Ctrl+Shift+Space` 呼出,从岛正下方展开:小桌面(默认)/AI 助手/剪贴板/设置四视图一键切换;**想搜就打字,结果与最近打开同屏**,搜索不再是界面,而是动作
...
1. 从 [Releases](https://github.com/sssst1118/aurora-desktop/releases) 下载安装包(推荐 `Aurora_0.1.0_x64-setup.exe`,备选 `Aurora_0.1.0_x64_en-US.msi`)
2. 双击安装并启动 Aurora
