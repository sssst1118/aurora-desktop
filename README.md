...
1. Download the installer from [Releases](https://github.com/sssst1118/aurora-desktop/releases) (`Aurora_0.2.7_x64-setup.exe` recommended, or `Aurora_0.2.7_x64_en-US.msi`)
